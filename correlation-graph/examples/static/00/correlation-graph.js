(function(global, factory) {
  ...
  function drawHelpText(props) {
    ...
    var helpText =
      "mouse over a node to see it's relationships. click the background to reset.";
    d3
      .select(selector)
      .append('g')
  ...
  function render(props) {
    ...
    var nodesAboveThresholdIds = nodesAboveThresholdSet
      .values()
      .map(function(d) {
        return Number(d);
      });
    ...
    var communityFunction = jLouvain()
