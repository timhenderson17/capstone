...
function render(props) {
  ...
  d3.select('body').append('svg').attr('height', 100).attr('width', 960).attr('class', 'sliderTextSVG').attr('style', 'font-family:Verdana, Geneva, serif; font-weight:5; font-size:1.3rem');
  ...
  d3.select('div#graph').append('div').attr('id', 'slider-container').attr('style', 'font-family:Verdana, Geneva, serif; font-weight:5; font-size:1.3rem');
